...
if __name__ == '__main__':
    num_files(r'C:/Users/user/PycharmProjects/Python-course/seminar7/test', bin=2, jpeg=1,
              avi=2, doc=4, mkv=6, png=4)
    sort_files(Path(r'C:/Users/user/PycharmProjects/Python-course/seminar7/test'))
